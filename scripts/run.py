...
KNS Runner v1.1
---------------
- Generates results in ../results/v1.1/test_#N/
...
def plot_summary_dashboard(runs: list[dict], out_dir: Path) -> Path:
    ...
    fig.suptitle("Dashboard — KNS v1.1", fontsize=14, y=0.98)
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="KNS Runner v1.1 — execute simulations and generate summaries"
    )
    parser.add_argument(
        "topologies_dir",
    ...
    results_root = root / "results" / "v1.1"
